	...
	return (
		<section id="contact" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
			<div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
				...
				<p className="text-sm sm:text-base text-gray-400 mb-6">Looking for a creative developer who builds immersive games, intuitive interfaces, and smooth animations?</p>
				...
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
					...
					<a
						href="/RD_Resume.pdf"
						target="_blank"
						rel="noopener noreferrer"  // ✅ Always good for external PDFs
				...
				<div className="flex justify-center gap-6">
					<a
						href="https://github.com/Rachit-Dwivedi-R-D"
						target="_blank"
